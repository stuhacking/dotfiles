...
(custom-set-faces
 ...
 '(org-level-1 ((t (:inherit outline-1))) t)
 '(outline-1 ((t (:inherit font-lock-function-name-face :underline t :weight bold))) t)
 '(outline-2 ((t (:inherit font-lock-variable-name-face :slant italic))) t))
